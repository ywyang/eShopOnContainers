...
docker push ${REGISTRY}/eshop/mobileshoppingapigw
docker push ${REGISTRY}/eshop/mobilemarketingapigw
docker push ${REGISTRY}/eshop/webshoppingapigw
docker push ${REGISTRY}/eshop/webmarketingapigw
